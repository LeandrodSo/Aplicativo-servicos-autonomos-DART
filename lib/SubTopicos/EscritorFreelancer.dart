...
class TelaEscritorFreelancer extends StatefulWidget {
  final int userId;

  TelaEscritorFreelancer({required this.userId});

  @override
  _TelaEscritorFreelancerState createState() => _TelaEscritorFreelancerState();
}

class _TelaEscritorFreelancerState extends State<TelaEscritorFreelancer> {

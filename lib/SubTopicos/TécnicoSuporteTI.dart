...
class TelaSuporteTI extends StatefulWidget {
  final int userId;

  TelaSuporteTI({required this.userId});

  @override
  _TelaSuporteTIState createState() => _TelaSuporteTIState();
}

class _TelaSuporteTIState extends State<TelaSuporteTI> {

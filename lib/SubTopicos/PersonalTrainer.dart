...
class TelaPersonalTrainer extends StatefulWidget {
  final int userId;

  TelaPersonalTrainer({required this.userId});

  @override
  _TelaPersonalTrainerState createState() => _TelaPersonalTrainerState();
}

class _TelaPersonalTrainerState extends State<TelaPersonalTrainer> {

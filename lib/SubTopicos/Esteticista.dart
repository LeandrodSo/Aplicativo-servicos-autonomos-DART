...
class TelaEsteticista extends StatefulWidget {
  final int userId;

  TelaEsteticista({required this.userId});

  @override
  _TelaEsteticistaState createState() => _TelaEsteticistaState();
}

class _TelaEsteticistaState extends State<TelaEsteticista> {

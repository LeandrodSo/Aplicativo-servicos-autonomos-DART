...
class TelaEspecialistaRedes extends StatefulWidget {
  final int userId;

  TelaEspecialistaRedes({required this.userId});

  @override
  _TelaEspecialistaRedesState createState() => _TelaEspecialistaRedesState();
}

class _TelaEspecialistaRedesState extends State<TelaEspecialistaRedes> {

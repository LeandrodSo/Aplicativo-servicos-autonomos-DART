...
class TelaEntregador extends StatefulWidget {
  final int userId;

  TelaEntregador({required this.userId});

  @override
  _TelaEntregadorState createState() => _TelaEntregadorState();
}

class _TelaEntregadorState extends State<TelaEntregador> {

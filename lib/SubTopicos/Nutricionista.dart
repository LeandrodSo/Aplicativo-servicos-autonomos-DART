...
class TelaNutricionista extends StatefulWidget {
  final int userId;

  TelaNutricionista({required this.userId});

  @override
  _TelaNutricionistaState createState() => _TelaNutricionistaState();
}

class _TelaNutricionistaState extends State<TelaNutricionista> {

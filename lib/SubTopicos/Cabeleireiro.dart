...
class TelaCabeleireiro extends StatefulWidget {
  final int userId;

  TelaCabeleireiro({required this.userId});

  @override
  _TelaCabeleireiroState createState() => _TelaCabeleireiroState();
}

class _TelaCabeleireiroState extends State<TelaCabeleireiro> {

...
class Massoterapeuta extends StatefulWidget {
  final int userId;

  Massoterapeuta({required this.userId});

  @override
  _MassoterapeutaState createState() => _MassoterapeutaState();
}

class _MassoterapeutaState extends State<Massoterapeuta> {

...
class TelaConsultorMarketing extends StatefulWidget {
  final int userId;

  TelaConsultorMarketing({required this.userId});

  @override
  _TelaConsultorMarketingState createState() => _TelaConsultorMarketingState();
}

class _TelaConsultorMarketingState extends State<TelaConsultorMarketing> {

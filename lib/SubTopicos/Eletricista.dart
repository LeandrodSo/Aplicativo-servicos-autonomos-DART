...
class TelaEletricista extends StatefulWidget {
  final int userId;

  TelaEletricista({required this.userId});

  @override
  _TelaEletricistaState createState() => _TelaEletricistaState();
}

class _TelaEletricistaState extends State<TelaEletricista> {

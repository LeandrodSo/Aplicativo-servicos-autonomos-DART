...
class TelaPedreiro extends StatefulWidget {
  final int userId;

  TelaPedreiro({required this.userId});

  @override
  _TelaPedreiroState createState() => _TelaPedreiroState();
}

class _TelaPedreiroState extends State<TelaPedreiro> {

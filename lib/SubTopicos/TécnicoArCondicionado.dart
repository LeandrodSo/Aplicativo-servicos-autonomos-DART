...
class TelaTecnicoArCondicionado extends StatefulWidget {
  final int userId;

  TelaTecnicoArCondicionado({required this.userId});

  @override
  _TelaTecnicoArCondicionadoState createState() =>
      _TelaTecnicoArCondicionadoState();
}

class _TelaTecnicoArCondicionadoState extends State<TelaTecnicoArCondicionado> {

...
class TelaMarceneiro extends StatefulWidget {
  final int userId;

  TelaMarceneiro({required this.userId});

  @override
  _TelaMarceneiroState createState() => _TelaMarceneiroState();
}

class _TelaMarceneiroState extends State<TelaMarceneiro> {

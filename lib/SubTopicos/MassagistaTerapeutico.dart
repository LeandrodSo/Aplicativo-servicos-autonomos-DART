...
class TelaMassagistaTerapeutico extends StatefulWidget {
  final int userId;

  TelaMassagistaTerapeutico({required this.userId});

  @override
  _TelaMassagistaTerapeuticoState createState() =>
      _TelaMassagistaTerapeuticoState();
}

class _TelaMassagistaTerapeuticoState extends State<TelaMassagistaTerapeutico> {

...
class TelaMotoristaAplicativo extends StatefulWidget {
  final int userId;

  TelaMotoristaAplicativo({required this.userId});

  @override
  _TelaMotoristaAplicativoState createState() =>
      _TelaMotoristaAplicativoState();
}

class _TelaMotoristaAplicativoState extends State<TelaMotoristaAplicativo> {

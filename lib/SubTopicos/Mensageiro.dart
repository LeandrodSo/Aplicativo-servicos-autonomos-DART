...
class TelaMensageiro extends StatefulWidget {
  final int userId;

  TelaMensageiro({required this.userId});

  @override
  _TelaMensageiroState createState() => _TelaMensageiroState();
}

class _TelaMensageiroState extends State<TelaMensageiro> {

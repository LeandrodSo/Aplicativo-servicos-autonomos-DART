...
class TelaEnfermeiro extends StatefulWidget {
  final int userId;

  TelaEnfermeiro({required this.userId});

  @override
  _TelaEnfermeiroState createState() => _TelaEnfermeiroState();
}

class _TelaEnfermeiroState extends State<TelaEnfermeiro> {

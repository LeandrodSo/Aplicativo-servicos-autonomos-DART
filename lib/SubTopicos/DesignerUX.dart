...
class TelaDesignerUX extends StatefulWidget {
  final int userId;

  TelaDesignerUX({required this.userId});

  @override
  _TelaDesignerUXState createState() => _TelaDesignerUXState();
}

class _TelaDesignerUXState extends State<TelaDesignerUX> {

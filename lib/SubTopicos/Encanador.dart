...
class TelaEncanador extends StatefulWidget {
  final int userId;

  TelaEncanador({required this.userId});

  @override
  _TelaEncanadorState createState() => _TelaEncanadorState();
}

class _TelaEncanadorState extends State<TelaEncanador> {

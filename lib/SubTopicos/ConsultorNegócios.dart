...
class TelaConsultorNegocios extends StatefulWidget {
  final int userId;

  TelaConsultorNegocios({required this.userId});

  @override
  _TelaConsultorNegociosState createState() => _TelaConsultorNegociosState();
}

class _TelaConsultorNegociosState extends State<TelaConsultorNegocios> {

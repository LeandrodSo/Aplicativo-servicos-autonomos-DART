...
class TelaDevMobile extends StatefulWidget {
  final int userId;

  TelaDevMobile({required this.userId});

  @override
  _TelaDevMobileState createState() => _TelaDevMobileState();
}

class _TelaDevMobileState extends State<TelaDevMobile> {

...
class TelaTratamentoPele extends StatefulWidget {
  final int userId;

  TelaTratamentoPele({required this.userId});

  @override
  _TelaTratamentoPeleState createState() => _TelaTratamentoPeleState();
}

class _TelaTratamentoPeleState extends State<TelaTratamentoPele> {

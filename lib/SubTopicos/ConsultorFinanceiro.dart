...
class TelaConsultorFinanceiro extends StatefulWidget {
  final int userId;

  TelaConsultorFinanceiro({required this.userId});

  @override
  _TelaConsultorFinanceiroState createState() =>
      _TelaConsultorFinanceiroState();
}

class _TelaConsultorFinanceiroState extends State<TelaConsultorFinanceiro> {

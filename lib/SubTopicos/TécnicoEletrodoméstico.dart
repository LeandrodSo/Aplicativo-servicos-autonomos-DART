...
class TelaTecnicoEletrodomestico extends StatefulWidget {
  final int userId;

  TelaTecnicoEletrodomestico({required this.userId});

  @override
  _TelaTecnicoEletrodomesticoState createState() =>
      _TelaTecnicoEletrodomesticoState();
}

class _TelaTecnicoEletrodomesticoState
    extends State<TelaTecnicoEletrodomestico> {

...
class TelaManicurePedicure extends StatefulWidget {
  final int userId;

  TelaManicurePedicure({required this.userId});

  @override
  _TelaManicurePedicureState createState() => _TelaManicurePedicureState();
}

class _TelaManicurePedicureState extends State<TelaManicurePedicure> {

...
class TelaDesignerUI extends StatefulWidget {
  final int userId;

  TelaDesignerUI({required this.userId});

  @override
  _TelaDesignerUIState createState() => _TelaDesignerUIState();
}

class _TelaDesignerUIState extends State<TelaDesignerUI> {

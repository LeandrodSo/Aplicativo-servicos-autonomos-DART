...
class TelaFisioterapeutaDomicilio extends StatefulWidget {
  final int userId;

  TelaFisioterapeutaDomicilio({required this.userId});

  @override
  _TelaFisioterapeutaDomicilioState createState() =>
      _TelaFisioterapeutaDomicilioState();
}

class _TelaFisioterapeutaDomicilioState
    extends State<TelaFisioterapeutaDomicilio> {

...
class TelaSegurancaCibernetica extends StatefulWidget {
  final int userId;

  TelaSegurancaCibernetica({required this.userId});

  @override
  _TelaSegurancaCiberneticaState createState() =>
      _TelaSegurancaCiberneticaState();
}

class _TelaSegurancaCiberneticaState extends State<TelaSegurancaCibernetica> {
